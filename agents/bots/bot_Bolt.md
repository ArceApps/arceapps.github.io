...
- **Imágenes:** Al crear contenido nuevo (Apps, Blog, Bitácora), **SIEMPRE** se debe incluir una imagen de portada (`heroImage`). Si falta, **genera un SVG minimalista** con colores de marca.
