...
- [x] AC1: The 8 target files (`create-issues.sh`, `QUICK_START.md`, `GITHUB_ISSUES_README.md`, `ISSUES_CREATION_GUIDE.md`, `ISSUES_LIST.md`, `ISSUE_SUMMARY.md`, `IMPLEMENTATION_SUMMARY.md`, `ANALISIS_WEB.md`) are completely deleted from the workspace.
- [x] AC2: All file deletions are staged and tracked in a Git feature branch.
- [x] AC3: Verification that `AGENTS.md` and `README.md` contain zero active references to the deleted files.
- [x] AC4: Project build passes successfully (`pnpm build`).
...
*   **Acceptance for this task:**
    *   [x] Feature branch `feature/arceapps_clean-issues-and-features` is created and active.
*   **Steps:**
    *   [x] **Step 1:** Create and switch to the new feature branch.
        ```bash
...
*   **Acceptance for this task:**
    *   [x] All 8 target files are removed from the disk and marked as deleted in Git.
*   **Steps:**
    *   [x] **Step 1:** Run git rm commands to delete the files.
        ```bash
        ...
        ```
    *   [x] **Step 2:** Verify that the files are deleted on disk and show as staged for deletion in `git status`.
        ```bash
        git status
        ```
    *   [x] **Step 3:** Commit the deletion step.
        ```bash
...
*   **Files:**
    *   Modify: `AGENTS.md`
*   **Acceptance for this task:**
    *   [x] No references to the deleted files exist in `AGENTS.md`.
*   **Steps:**
    *   [x] **Step 1:** Search for any remaining reference strings in `AGENTS.md`.
        ```bash
        grep -Ei "create-issues|QUICK_START|ANALISIS_WEB|ISSUES_LIST|ISSUE_SUMMARY|IMPLEMENTATION_SUMMARY" AGENTS.md || true
        ```
    *   [x] **Step 2:** If any references are found, edit `AGENTS.md` to remove them, then stage and commit the changes.
        ```bash
        git add AGENTS.md
...
*   **Files:** None
*   **Acceptance for this task:**
    *   [x] Project compiles successfully using Astro's build process.
*   **Steps:**
    *   [x] **Step 1:** Run the production build command.
        ```bash
        pnpm build
        ```
    *   [x] **Step 2:** Verify the exit code is 0 and no build errors occurred.
