...
Esto enseña **Pensamiento Crítico**, que es la habilidad que la IA no puede reemplazar.
...
*   **Sesiones de Revisión de Código:** No te limites a comentar en PRs. Siéntate (o comparte pantalla) y recorre la lógica. Pregunta, "¿Qué pasa si esta llamada de red falla?" o "¿Cómo maneja esto los cambios de orientación?".
*   **Mentalidad de Pruebas:** Enséñales a escribir pruebas *antes* o *junto con* el código de la IA para verificar el comportamiento, no solo la implementación.
...
La mentoría ya no se trata de transferir conocimiento; se trata de transferir **sabiduría**. Se trata de enseñar los patrones, las trampas y los principios arquitectónicos que gobiernan el software robusto.
