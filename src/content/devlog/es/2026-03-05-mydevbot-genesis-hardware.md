---
title: "2026-03-05: El Nacimiento de mydevbot y la Odisea del Hardware (mydevbot)"
description: "Como surge la necesidad de controlar mi ecosistema de desarrollo desde Telegram, el analisis del repositorio AIPAL, la decepcion con el Synology DS212+ y la decision final por un Mini PC con el SDK nativo de Gemini."
pubDate: 2026-03-05
lastmod: 2026-03-05
author: "ArceApps"
keywords: ["mydevbot", "devlog", "telegram", "gemini", "hardware"]
canonical: "https://arceapps.com/es/devlog/2026-03-05-mydevbot-genesis-hardware/"
...
A veces, las soluciones más útiles no provienen de tener una idea revolucionaria y original, sino de aplicar conceptos ya existentes para resolver frustraciones cotidianas. Era un jueves por la tarde, estaba en el transporte público volviendo a casa, y recordé que no había revisado una Pull Request en uno de mis repositorios personales. Saqué el móvil, abrí el navegador, entré a GitHub y sufrí la típica experiencia móvil: hacer zoom, intentar pulsar el botón correcto, lidiar con la conexión intermitente del metro...

No soy el primero ni el último desarrollador en pensar: *"Tiene que haber una forma más fácil de gestionar esto desde el móvil"*. Internet está lleno de tutoriales y herramientas para conectar aplicaciones de mensajería con APIs y LLMs. No es ninguna novedad tecnológica. Herramientas comerciales recientes como **Clawbot** (o Clawdbot) han popularizado enormemente la idea de interactuar con tus repositorios e infraestructura a través de un chat.

Mi objetivo no era inventar la rueda, sino ahorrarme un montón de trabajo de gestión diaria. Telegram es rápido, ligero, funciona perfectamente con coberturas pésimas y tiene una API fantástica. Quería mi propio asistente ahí, impulsado por Inteligencia Artificial, pero con un matiz crucial: quería que fuera una solución privada, soberana y autoalojada. Así nació **mydevbot**.

En esta primera entrada voy a relatar los primeros pasos de este proyecto de integración y automatización, empezando por la elección del hardware. Porque, aunque evalué opciones comerciales excelentes como Clawbot, decidí descartarlas en favor de algo "hecho en casa" para mantener un control absoluto sobre mis repositorios privados.

### El punto de partida: Explorando el ecosistema existente y la inspiración

Como mencionaba, el concepto de un bot inteligente no es nuevo. Durante mi investigación para montar mi propia versión, volví a encontrarme con un repositorio que siempre me ha parecido una referencia fantástica: [AIPAL](https://github.com/antoniolg/aipal), creado por antoniolg.
